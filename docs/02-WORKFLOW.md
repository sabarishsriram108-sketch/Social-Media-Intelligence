...
- **Instagram cycles STATEMENT → DATA → INSIGHT.** The profile grid then forms a diagonal ink/accent/paper rhythm on its own. Break the cycle and the grid stops reading as designed.
- **One palette per campaign.** Switch between campaigns (`--palette=signal`), never within one.
